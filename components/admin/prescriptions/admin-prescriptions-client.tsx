...
interface AdminPrescriptionsClientProps {
  initialPrescriptions: Prescription[]
}

export function AdminPrescriptionsClient({ initialPrescriptions }: AdminPrescriptionsClientProps) {
              ...
              <Card key={prescription.id} className="border border-gray-200">
                <CardContent className="p-4">
                  ...
                  <div className="flex gap-2 mt-4">
                    <Button variant="outline" size="sm" className="flex-1" onClick={() => handleViewReports(prescription)}>
                      <FileText className="w-4 h-4 mr-2" />
                      Reports
                    </Button>
                    <Button variant="outline" size="sm" className="flex-1" onClick={() => handleViewPrescriptions(prescription)}>
                      <FileText className="w-4 h-4 mr-2" />
                      Prescriptions
                    </Button>
                  </div>
              ...
              <Table>
                <TableHeader className="bg-[#f4f3ff] rounded-[10px]">
                  <TableRow>
                    ...
                    <TableHead className="text-[#888888] text-lg font-sf-pro font-medium">Reports</TableHead>
                    <TableHead className="text-[#888888] text-lg font-sf-pro font-medium">Prescriptions</TableHead>
                    <TableHead className="text-[#888888] text-lg font-sf-pro font-medium">Action</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {paginatedPrescriptions.map((prescription, index) => (
                    <TableRow key={prescription.id} className="bg-[#f4f3ff] rounded-[10px] my-[10px]">
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          <Button variant="ghost" size="icon" onClick={() => handleEdit(prescription.id)}>
